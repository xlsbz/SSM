					...
					<form id="loginForm" action="${pageContext.request.contextPath }/user/login"  method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="loginType" name="loginType" class="text" maxlength="20" value="">
							...
							<tr>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="code" name="code" class="text captcha" maxlength="4" autocomplete="off"><img id="changeCheck" onclick="changeImage()" class="captchaImage" src="${pageContext.request.contextPath}/imageCode" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
								...
								<td>
									...
									<label>
										&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/user/toBackPassword">找回密码</a>
									</label>
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="submit" class="submit" value="登 录"><span>${msg }</span>
								</td>
							</tr>
							<tr class="register">
								<th>&nbsp;
...
<script type="text/javascript">
	...
	//获取cookie里面保存的用户名
	var val = "${cookie.save_name.value}";
	document.getElementById("loginType").value = decodeURIComponent(val);
	//对cookie解码
