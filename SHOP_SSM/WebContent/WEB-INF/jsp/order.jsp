...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<c:forEach items="${orderBean.orderItems }" var="order">
						<tr>
							<td width="60">
								<input type="hidden" name="pid" value="${order.product.pid}"/>
								<img src="${pageContext.request.contextPath }/image/${order.product.image}"/>
							</td>
							<td>
				...
				<div class="total">
					<em id="promotion"></em>
					订单金额: <strong id="effectivePrice">￥${orderBean.total}元</strong>
				</div>
			<form id="orderForm" action="${pageContext.request.contextPath }/order/activeOrder" method="post">
				<input type="hidden" name="oid" value="${orderBean.oid}"/>
				<div class="span24">
					<p>
							收货地址：<input name="addr" type="text" value="填写您的收货地址" style="width:350px" />
								<br />
							收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${orderBean.user.username}" style="width:150px" />
								<br /> 
							联系方式：<input name="phone" type="text" value="填写您的联系方式" style="width:150px" />
