	...
	function checkUsername(username){
		...
		$.ajax({
			...
			success:function(data){
				document.getElementById("checkName").innerHTML = data.msg;
			}
		});
	}
	
	function changeImage() {
		var change = document.getElementById("changeCheck");
		change.src = "${pageContext.request.contextPath}/imageCode?time="+new Date().getTime();
	}
</script>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action="${pageContext.request.contextPath }/user/userRegister" method="post" novalidate="novalidate">
						<table>
							<tbody><tr>
								<th>
							...
							<tr>
								...
								<td>
									<input type="text" id="t" name="name" class="text" maxlength="20" autocomplete="off"/>
								</td>
							</tr>
								<th>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkcode" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="changeCheck" class="captchaImage" src="${pageContext.request.contextPath}/imageCode" onclick="changeImage()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
								...
								<td>
									<input type="submit" class="submit" value="同意以下协议并注册"><span>${requestScope.msg }</span>
								</td>
							</tr>
							<tr>
								<th>&nbsp;
