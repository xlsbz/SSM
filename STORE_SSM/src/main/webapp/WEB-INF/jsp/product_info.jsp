		...
		<div class="container">
			<div class="row">
				<div style="border: 1px solid #e4e4e4;width:930px;margin-bottom:10px;margin:0 auto;padding:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath}/">该商品所属一级分类&nbsp;&nbsp;&gt;</a>
					<a href="${pageContext.request.contextPath}/">&nbsp;&nbsp;&gt;</a>
					<a>${productBean.pname }</a>
				</div>
				...
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${productBean.shopPrice }元/份</strong> 参 考 价： <del>￥${productBean.marketPrice }元/份</del>
						</div>
