...
<html>
	...
	<body>
		...
		<div class="container">
					...
					<table class="table table-bordered">
						<tbody>
							<c:forEach items="${orders.orderitems}" var="oi">
								<tr class="warning">
									<th colspan="5">订单项编号:${oi.itemid }</th>
								</tr>
								<tr class="warning">
									<th>图片</th>
									<th>商品</th>
			...
			<div>
				<hr/>
				<form class="form-horizontal" method="post" id="orderForm" action="${pageContext.request.contextPath }/order/sureOrder" style="margin-top:5px;margin-left:150px;">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="name" value="${user.username }" class="form-control" id="" placeholder="请输收货人">
						</div>
					</div>
					<div class="form-group">
						<label for="confirmpwd" class="col-sm-1 control-label">电话</label>
						<div class="col-sm-5">
							<input type="text" name="telephone" value="${user.telephone }" class="form-control" id="confirmpwd" placeholder="请输入联系方式">
						</div>
					</div>
				</form>
