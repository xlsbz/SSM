...
font {
	...
	<script type="text/javascript">
		...
		function checkUser(username){
			$.ajax({
				url:"${pageContext.request.contextPath}/user/userCheck?username="+username,
				type:"GET",
				data:null,
				success:function(data){
					document.getElementById("checkUser").innerHTML = data.msg;
				}
			});
		}
	</script>
...
<div class="row"> 
	...
	<div class="col-md-8" style="background: #fff; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
					...
					<form class="form-horizontal" style="margin-top: 5px;" method="post" action="userRegister">
						<div class="form-group">
							<label for="username" class="col-sm-2 control-label">用户名</label>
							<div class="col-sm-6">
								<input type="text" class="form-control" id="username" 
									placeholder="请输入用户名" name="username" onblur="checkUser(this.value)" >
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
							 ...
							 <div class="col-sm-3">
      							<img id="changeImage" title="换一张" src="${pageContext.request.contextPath}/imageCode"  onclick="cImage()"/>
   							 </div>
